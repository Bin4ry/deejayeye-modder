...
java -jar download.jar https://github.com/appium/sign/raw/master/dist/sign.jar sign.jar
java -jar download.jar https://github.com/eleme/bspatch/blob/master/tools/windows/bspatch.exe bspatch.exe
